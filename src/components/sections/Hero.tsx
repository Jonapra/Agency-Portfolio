...
export const Hero = () => {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[100svh] md:min-h-0 pt-20 md:pt-24 lg:pt-28 2xl:pt-32 md:pb-20 lg:pb-24 2xl:pb-28 overflow-hidden hero-section-text flex flex-col"
    >
      ...
      <SectionContainer className="relative w-full flex-1 flex flex-col">
        ...
        <div className="mt-auto md:mt-12 lg:mt-16 2xl:mt-20 pt-6 md:pt-8 lg:pt-10 2xl:pt-12">
          <motion.div 
